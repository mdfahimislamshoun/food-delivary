...
const PSlider = () => {
  ...
  return (
    <div className='slider py-5 bg-slider h-[600px] mt-10'>
        <h1 className='text-center text-3xl  text-white font-medium mt-6'>
            Fresh Vegetable Recipes To Bring
            <br /> To Your Next Cookout
        </h1>
        <div className='container w-[90%] mt-5 justify-center mx-auto'>
            <Slider {...settings}>
                <div className='p-1'>
                    <SProduct 
                        Image = {Veg1}
